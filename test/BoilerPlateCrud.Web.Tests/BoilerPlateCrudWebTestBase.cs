...
{
    public abstract class BoilerPlateCrudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoilerPlateCrudWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoilerPlateCrudWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoilerPlateCrudDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoilerPlateCrudDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoilerPlateCrudDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoilerPlateCrudDbContext, Task<T>> func)
        {
            T result;
