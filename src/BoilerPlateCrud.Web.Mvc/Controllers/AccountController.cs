...
using BoilerPlateCrud.Sessions;
using BoilerPlateCrud.Web.Models.Account;
using BoilerPlateCrud.Web.Views.Shared.Components.TenantChange;

namespace BoilerPlateCrud.Web.Controllers
{
    public class AccountController : BoilerPlateCrudControllerBase
    {
